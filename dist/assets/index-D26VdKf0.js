...
`,Q7=()=>{const e=P({});j.useEffect(()=>{de({method:"get",service:"customers",endpoint:"/statistics",onSuccess:d=>e.set(d),enableToast:!0})},[]);const{customersCount:t,customersIncreasePreviousMonth:r,largestSegment:n,largestState:o,percentageOfCustomersInLargestState:i,percentageOfCustomersInLargestSegment:l}=e.value,s=a.jsxs("p",{children:[a.jsxs("b",{children:[l==null?void 0:l.slice(0,4),"%"]})," dos seus clientes são desse segmento"]}),c=a.jsxs("p",{children:[a.jsxs("b",{children:[i==null?void 0:i.slice(0,4),"%"]})," dos seus clientes estão aqui"]}),u=a.jsxs(a.Fragment,{children:[a.jsxs("span",{className:r>0?"increase":r<0?"decrease":"",children:[r>0?a.jsxs(a.Fragment,{children:[a.jsx(Fw,{})," -"," "]}):r<0?a.jsxs(a.Fragment,{children:[a.jsx(Lw,{})," +"," "]}):a.jsx(a.Fragment,{children:"+"}),r,"%"]}),"em relação ao mês anterior"]});return a.jsx(V2,{children:a.jsxs("div",{children:[a.jsx(wo,{icon:a.jsx(uv,{}),title:"Clientes Ativos",mainValue:t==null?void 0:t.toLocaleString("pt-BR"),subValue:u}),a.jsx(wo,{icon:a.jsx(yC,{}),title:"Maior Segmento",mainValue:n,subValue:s}),a.jsx(wo,{icon:a.jsx(sC,{}),title:"Maior Estado",mainValue:o,subValue:c})]})})},J7=()=>a.jsxs(V7,{children:[a.jsxs("div",{children:[a.jsx("h1",{children:" Cadastro de Clientes "}),a.jsx(Q7,{})]}),a.jsx("div",{children:a.jsx(pt,{children:a.jsx(Po,{to:"/clientes/cadastrar",children:"Adicionar novo cliente"})})}),a.jsx(q7,{}),a.jsx(m4,{})]}),X7=Q.li`
    box-sizing: border-box;
    display: flex;
    align-items: center;
    justify-content: space-between;

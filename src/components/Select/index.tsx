...
function Select<T>({
    ...
    const filteredOptions = (optionState.value?.name === inputValue.value) ? options :
        options.filter(o => removeAccents(o.name?.toLowerCase()).includes(removeAccents(inputValue.value?.toLowerCase())))
        ...
        <StyledSelect {...{
            ...
            <div>
                ...
                />
                {
                    ...
                    <div className="icons">
                        {
                            !disableClearButton && optionState.value &&
                            <FaXmark onClick={() => optionState.set(null)} />
                        }
                        {
            ...
            <ul
                className={(!disabled && displayMenuState.value) ? "showing" : "hidden"}
            >
                {

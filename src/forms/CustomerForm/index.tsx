...
const CustomerForm = ({ mode }: CustomerFormProps) => {
    ...
    const onRegister = () => {
        ...
        customRequest<{ message: string, data?: Customer }, Partial<Customer>>({
            service: "customers",
            endpoint: "/customers",
            method: "post",
            requestData: CLIENTE,
            onSuccess: ((data) => {
                ...
                CONTATOS?.length && CONTATOS.forEach(c => {
                    customRequest<{ message: string, data?: Contact }, Partial<Contact>>({
                        service: "customers",
                        endpoint: "/contacts",
                        method: "post",
                        requestData: c,
    ...
    useEffect(() => {
        if (mode === "edit") {
            ...
            // Carrega cliente
            customRequest<{ data: Customer }, never>({
                method: "get",
                service: "customers",
